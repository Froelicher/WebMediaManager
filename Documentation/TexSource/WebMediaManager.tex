...
\newpage
	...
	Il n'y a pas d'application similaire à celle que je vais réaliser. Tout de même, les différentes fonctions que je veux y intégrée sont déjà présente sur les différents sites.
		\subsection{Existant}
		\begin{itemize}
			\item Twitch.tv : Site officiel de Twitch
			\item Youtube.com : Site officiel de Youtube
			\item Dailymotion.com : Site officiel de Dailymotion
		\end{itemize}			
		\subsection{Critique de l'existant}	
		\textbf{Twitch.tv} : Sur le site officiel de Twitch, nous avons la possibilité de regarder des diffusions en direct, de regarder des rediffusions.	
