       ...
       /*private void CreateTextBox()
        {
           ...
           this.Chat.ScrollBars = ScrollBars.Vertical;
        ...
        private void InitIrc()
        {
            var user = new IrcUser("grunghi", "grunghi", "oauth:0w0w9dxtdxr6qrri1qnk553uqnu2b1");
                ...
                client.ConnectionComplete += (s, e) => client.JoinChannel("#nl_kripp");
        ...
        private void CreateTextBox()
        {
            ...
            this.Chat.Location = new Point(0, 0);
            this.Chat.Multiline = true;
            this.Chat.Size = new Size(250, 500);
            this.Chat.ScrollBars = ScrollBars.Vertical;
            this.Controls.Add(this.Chat);
        }
        ...
        public void ConnectIrc()
        {
            ...
            client.ChannelMessageRecieved += (s, e) =>
            {
                this.Chat.Invoke(new MethodInvoker(delegate { this.Chat.AppendText("<" + e.PrivateMessage.User.Nick + ">" + " " + e.PrivateMessage.Message + "\n"); }));
            };
            client.ChannelTopicReceived += (s, e) =>
            {
                this.Chat.Invoke(new MethodInvoker(delegate { this.Chat.AppendText("Received topic for channel " + e.Channel.Name + ": " + e.Topic + "\n"); }));
            };
